...
I'm using the code from another generous [github user](https://github.com/alshedivat/al-folio) as a template, so the site will still be littered with some template stuff. Over time, I hope to develop this site out to truly make it mine, although the process is a bit tedious and it could take a while—appreciate the patience. 
