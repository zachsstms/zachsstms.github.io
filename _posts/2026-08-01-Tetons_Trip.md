...
After a couple thousand feet of thuggin' up the trail, it took just a few hours to gain the non-prominent [Idol and Worshipper](https://peakvisor.com/peak/idol-and-worshipper.html). Yet, the little gendarme is also where the snowline was encountered, which complicating things immensely. The issue was that the snowfield was sitting above a large cliff-band <d-footnote>I am pretty sure that the cliff-band is the reason Teewinot is the [deadliest mountain in the Tetons](https://tenthousandtoofar.com/2021/09/06/the-deadliest-route-in-the-tetons-the-east-face-of-teewinot-mountain/)</d-footnote>
