...
<div class="text-center mt-3 mb-4">
    <a href="{{ 'assets/pdf/Biconvex-3.pdf' | relative_url }}" class="btn btn-sm z-depth-1" download="Biconvex-3.pdf">
        <i class="fas fa-file-download"></i> Download Report PDF
    </a>
</div>
<iframe src="{{ 'assets/pdf/Biconvex-3.pdf' | relative_url }}" width="100%" height="600px">
    This browser does not support PDFs. Please download the PDF to view it: 
    <a href="{{ 'assets/pdf/Biconvex-3.pdf' | relative_url }}">Download PDF</a>.
</iframe>